...
```
```
19:53:10.606 [     work] 작업 중
19:53:13.613 [     work] 작업 중
19:53:14.599 [     main] 작업 중단 지시 thread.interrupt
19:53:14.602 [     main] work 스레드 인터럽트 = true
19:53:14.604 [     work] work 스레드 인터럽트 상태2 = false
19:53:14.604 [     work] interrupt message = sleep interrupted
19:53:14.604 [     work] state = RUNNABLE
19:53:14.605 [     work] 자원 정리
19:53:14.605 [     work] 작업 종료
```
...
docker builx -> 어떤 아키텍쳐(x86, arm)를 모두 호환하게 도와준다.